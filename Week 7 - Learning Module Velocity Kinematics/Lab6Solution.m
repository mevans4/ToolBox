...
% Note: If experiencing an issue where the figure zooms out after running
% 'robot.plot3d', you can either:
% A. Right click on the figure, go to 'rotate options' and select
% 'stretch-to-fill axes'
% B. Change the line from 'robot.plot3d(q)' to 'robot.animate(q)', however
% note that this MAY change the colouration of the robot links.
robot = SchunkUTSv2();
q = [0,pi/2,0,0,0,0];
...
keyboard
%input('Press enter to continue to Q2')
...
keyboard
%input('Press enter to continue to Q3')

%% Question 3
% Joint Interpolation vs RMRC
clear all
close all
clc
set(0,'DefaultFigureWindowStyle','docked');
...
% 3.4) Use jtraj(q1,q2,steps) to interpolate and plot trail
